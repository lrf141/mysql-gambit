...
/** @file ha_gambit.h
  ...
  /storage/gambit/ha_gambit.cc.

    @note
  Please read ha_gambit.cc before reading this file.
  Reminder: The gambit storage engine implements all methods that are
  *required* to be implemented. For a full list of all methods that you can
  implement, see handler.h.

   @see
  /sql/handler.h and /storage/gambit/ha_gambit.cc
*/
...
class ha_gambit : public handler {
 ...
 public:
   ...
   */
  const char *table_type() const { return "GAMBIT"; }
  ...
  */
  ...
  /*
    Everything below are methods that we implement in ha_gambit.cc.

    Most of these methods are not obligatory, skip them and
    MySQL will treat them as not implemented
  */
  /** @brief
    We implement this in ha_gambit.cc; it's a required method.
  */
  ...
  */
  ...
  /** @brief
    We implement this in ha_gambit.cc. It's not an obligatory method;
